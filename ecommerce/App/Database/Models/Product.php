...
class Product extends Model implements Crud { private $id, $name_en, $name_ar, $price, $quantity, $status, $image, $code, $desc_en, 
    $desc_ar, $brand_id,$subcategory_id,$category_id, $created_at, $updated_at;
