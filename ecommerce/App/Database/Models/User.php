...
class User extends Model implements Crud {private $id, $first_name, $last_name, $gender, $email, $password, $phone, $status, $image,
 $email_verified_at, $updated_at, $verification_code, $created_at; 
...
return $this;
  ...
  */ 
  ...
  public function create () {
     ...
     $statment->bind_param('ssssssi',$this->first_name,$this->last_name,$this->email,
...
// }
 ...
 public function checkCode()
 {
     ...
     $statment = $this->connection->prepare($query);
     $statment->bind_param('is',$this->verification_code,$this->email);
     $statment->execute();
     return $statment;
 }
...
public function UserVerified() {
   ...
   $statment = $this->connection->prepare($query);
   $statment->bind_param('ss',$this->email_verified_at,$this->email);
   return $statment->execute();
}
