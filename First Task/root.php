          ...
          <div class="row">
              ...
              <div class="col-6 offset-3">
                  <form method="post">
                    ...
                    <div class="form-group">
                        <label for="Root"> Enter degree of root</label>
                        <input type="number" name="root" id="num" class="form-control" placeholder="" aria-describedby="helpId">
